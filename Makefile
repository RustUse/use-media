...
CRATE := use-media
FOCUSED_CRATES := use-aspect-ratio use-dimensions use-resolution use-frame-rate use-image use-bitrate use-media-duration use-media-timestamp use-media-type use-svg
